...
def main() -> None:
    parser = argparse.ArgumentParser(description="Predict protein sequences with KaleProtein MapDiff-style model.")
    ...
    print("1. load data: processed residue graph .pt files")
    ...
    print("4. generate: AutoProteinGenerator samples residue sequences")
    ...
    (output_dir / "predictions.json").write_text(json.dumps({"predictions": predictions}, indent=2) + "\n", encoding="utf-8")
