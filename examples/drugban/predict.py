...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run KaleProtein DrugBAN prediction on configured input CSV.")
    ...
    print("4. predict: AutoProteinPredictor consumes embeddings")
    ...
    (output_dir / "predictions.json").write_text(json.dumps({"predictions": rows}, indent=2) + "\n", encoding="utf-8")
