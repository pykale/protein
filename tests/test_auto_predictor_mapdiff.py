...
from kaleprotein.core.data.collators.inverse_folding import CollatorDiff
from kaleprotein.core.data.datasets.inverse_folding import build_residue_graph
