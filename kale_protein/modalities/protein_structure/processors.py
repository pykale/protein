...
@MODALITY_PROCESSOR_REGISTRY.register(
    ("protein_structure", "backbone_coordinate_processor"),
    aliases=(("protein/structure", "backbone_coords"),),
)
class BackboneCoordinateProcessor:
    ...
    def transform(self, sample):
        from kale_protein.tasks.inverse_folding.datasets import (
        ...
        return {
            ...
            # tensor-native graph/atom_pos fields used by MapDiff.
