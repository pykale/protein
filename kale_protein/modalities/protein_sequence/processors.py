...
@MODALITY_PROCESSOR_REGISTRY.register(
    ('protein_sequence','amino_acid_tokenizer'),
    aliases=(("protein/sequence", "sequence"),),
)
...
@MODALITY_PROCESSOR_REGISTRY.register(
    ('protein_sequence','masked_sequence_tokenizer'),
    aliases=(("protein/masked_sequence", "sequence"),),
)
